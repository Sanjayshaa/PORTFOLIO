...
const normalizeItem = (it: string | DepthCarouselItem): DepthCarouselItem => (typeof it === 'string' ? { image: it, alt: '' } : it);
...
export interface DepthCarouselProps {
  ...
  renderCardContent?: (item: DepthCarouselItem, index: number, isActive: boolean) => ReactNode;
    ...
    >
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          ...
          >
            {renderCardContent ? (
              renderCardContent(item, i, active === i)
            ) : (
              <>
