  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        {/* Editorial Logo */}
        <a href="#hero" className="sm-logo group flex items-center gap-2">
          <div className="p-1.5 rounded-lg bg-[#0D1117] border border-[#242A33] text-[#A78BFA]">
            <Code2 size={18} />
          </div>
          <span className="font-display font-extrabold text-base tracking-tight text-white">
            SANJAY<span className="text-[#A78BFA]">.S</span>
          </span>
        </a>

        {/* Minimal Header Toggle Button */}
        <button
          ref={toggleBtnRef}
          className="sm-toggle"
